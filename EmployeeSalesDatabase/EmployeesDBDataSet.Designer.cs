...
namespace EmployeeSalesDatabase {
    ...
    public partial class EmployeesDBDataSet : global::System.Data.DataSet {
        ...
        public partial class employeesDataTable : global::System.Data.TypedTableBase<employeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public employeesRow AddemployeesRow(string firstname, string lastname, string title, System.DateTime birthdate) {
...
namespace EmployeeSalesDatabase.EmployeesDBDataSetTableAdapters {
    ...
    public partial class employeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[employees] ([firstname], [lastname], [title], [birthdate]) VAL" +
                "UES (@firstname, @lastname, @title, @birthdate);\r\nSELECT Id, firstname, lastname" +
                ", title, birthdate FROM employees WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[employees] SET [firstname] = @firstname, [lastname] = @lastname, [title] = @title, [birthdate] = @birthdate WHERE (([Id] = @Original_Id) AND ((@IsNull_firstname = 1 AND [firstname] IS NULL) OR ([firstname] = @Original_firstname)) AND ((@IsNull_lastname = 1 AND [lastname] IS NULL) OR ([lastname] = @Original_lastname)) AND ((@IsNull_title = 1 AND [title] IS NULL) OR ([title] = @Original_title)) AND ((@IsNull_birthdate = 1 AND [birthdate] IS NULL) OR ([birthdate] = @Original_birthdate)));
SELECT Id, firstname, lastname, title, birthdate FROM employees WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::EmployeeSalesDatabase.Properties.Settings.Default.EmployeesDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, firstname, lastname, title, birthdate FROM dbo.employees";
        ...
        public virtual int Delete(int Original_Id, string Original_firstname, string Original_lastname, string Original_title, global::System.Nullable<global::System.DateTime> Original_birthdate) {
        ...
        public virtual int Insert(string firstname, string lastname, string title, global::System.Nullable<global::System.DateTime> birthdate) {
            if ((firstname == null)) {
        ...
        public virtual int Update(string firstname, string lastname, string title, global::System.Nullable<global::System.DateTime> birthdate, int Original_Id, string Original_firstname, string Original_lastname, string Original_title, global::System.Nullable<global::System.DateTime> Original_birthdate, int Id) {
            if ((firstname == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string firstname, string lastname, string title, global::System.Nullable<global::System.DateTime> birthdate, int Original_Id, string Original_firstname, string Original_lastname, string Original_title, global::System.Nullable<global::System.DateTime> Original_birthdate) {
            return this.Update(firstname, lastname, title, birthdate, Original_Id, Original_firstname, Original_lastname, Original_title, Original_birthdate, Original_Id);
        }
    }
